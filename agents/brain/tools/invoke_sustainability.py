"""Lambda invoke wrapper for Sustainability Manager.

Invokes the factorymind-sustainability-manager Lambda function
...
def invoke_sustainability(
    ...
    """Invoke the Sustainability Manager Lambda function.
    ...
    Returns:
        Response payload from the Sustainability Manager.
    ...
    logger.info(
        "invoking_sustainability_manager",
    ...
    if response.get("FunctionError"):
        logger.error(
            "sustainability_invocation_failed",
            function_name=FUNCTION_NAME,
            error=response_payload,
            elapsed_ms=elapsed_ms,
        )
        raise RuntimeError(
            f"Sustainability Manager invocation failed: {response_payload}"
        )

    logger.info(
        "sustainability_invocation_complete",
        function_name=FUNCTION_NAME,
        elapsed_ms=elapsed_ms,
    )
